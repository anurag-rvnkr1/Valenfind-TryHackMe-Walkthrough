...
![Nmap Scan](../docs/assets/recon/nmap-scan.png)
...
![Gobuster Enumeration](../docs/assets/recon/gobuster-enumeration.png)
...
![Homepage](../docs/assets/application/homepage.png)
...
![Register Page](../docs/assets/application/register-page.png)
...
![Complete Profile](../docs/assets/application/complete-profile.png)
...
![Login Page](../docs/assets/application/login-page.png)
...
![Dashboard](../docs/assets/application/dashboard.png)
...
![Profile Page](../docs/assets/application/profile-page.png)
...
![Network Inspector](../docs/assets/application/network-inspector.png)
...
![LFI Request](../docs/assets/lfi/lfi-request.png)
---
...
![etc passwd Response](../docs/assets/lfi/etc-passwd-response.png)
...
![Process Information](../docs/assets/lfi/proc-self-cmdline.png)
...
![Flask Source](../docs/assets/source-analysis/app-source-code.png)
...
![Flask Routes](../docs/assets/source-analysis/flask-routes.png)
...
![Hardcoded Secret](../docs/assets/source-analysis/hardcoded-secret-redacted.png)
...
![Admin Endpoint](../docs/assets/source-analysis/admin-endpoint.png)
...
![Admin Request](../docs/assets/source-analysis/admin-request.png)
...
![Database Download](../docs/assets/database/download-database.png)
...
![SQLite Open](../docs/assets/database/sqlite-open.png)
...
![Users Schema](../docs/assets/database/users-schema.png)
...
![Users Table](../docs/assets/database/users-table-redacted.png)
